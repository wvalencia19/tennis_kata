...
func runSuiteOnGame(t *testing.T, factory func(player1Name string, player2Name string) Game) {
	for _, sample := range testData {
		t.Run(fmt.Sprintf("%d %d", sample.player1Score, sample.player2Score), func(t *testing.T) {
...
func TestGame(t *testing.T) {
	runSuiteOnGame(t, func(player1Name string, player2Name string) Game { return TennisGame(player1Name, player2Name) })
}
